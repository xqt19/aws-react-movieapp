...
class MovieDataService {
    retrieveAllMovies(view){
        return axios.get(`https://q7z7wqfyjf.execute-api.ap-southeast-1.amazonaws.com/xqpoc/movies`)
    ...
    createNewMovie(movie){
        return axios.post(`https://q7z7wqfyjf.execute-api.ap-southeast-1.amazonaws.com/xqpoc/movies`, movie)
    ...
    deleteMovie(id){
        return axios.delete(`https://q7z7wqfyjf.execute-api.ap-southeast-1.amazonaws.com/xqpoc/movies/${id}`)
    ...
    updateMovie(movie){
        return axios.put(`https://q7z7wqfyjf.execute-api.ap-southeast-1.amazonaws.com/xqpoc/movies`,movie)
    ...
    getMovie(id){
        return axios.get(`https://q7z7wqfyjf.execute-api.ap-southeast-1.amazonaws.com/xqpoc/movies/${id}`)
